  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  <Button size="lg" className="rounded-full" asChild data-testid="button-start-trial">
                    <a href="/api/login">
                      Start Your Free Trial
                      <ArrowRight className="ml-2 w-4 h-4" />
                    </a>
                  </Button>
                  <Button size="lg" variant="ghost" className="gap-2" data-testid="button-watch-demo">
                ...
                <div className="flex items-center gap-4 pt-4">
                  ...
                  <p className="text-sm text-muted-foreground" data-testid="text-trust-badge">
              ...
              <div className="relative lg:pl-8">
                <div className="bg-card rounded-2xl border border-border shadow-2xl shadow-primary/5 p-6 space-y-4" data-testid="card-dashboard-preview">
                  {/* Balance cards */}
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-primary rounded-xl p-4 text-primary-foreground">
                      <p className="text-xs opacity-80 mb-1" data-testid="text-label-balance">Total Balance</p>
                      <p className="text-2xl font-bold font-mono" data-testid="text-preview-balance">$12,450.00</p>
                    </div>
                    <div className="bg-muted rounded-xl p-4">
                      <p className="text-xs text-muted-foreground mb-1" data-testid="text-label-savings">Total Savings</p>
                      <p className="text-2xl font-bold font-mono" data-testid="text-preview-savings">$5,200.00</p>
                    </div>
                  </div>

                  {/* Transaction items */}
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg" data-testid="row-transaction-split">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-accent flex items-center justify-center">
                          <TrendingUp className="w-4 h-4 text-accent-foreground" />
                        </div>
                        <span className="text-sm font-medium" data-testid="text-transaction-split">Split Instant</span>
                      </div>
                      <span className="text-sm text-muted-foreground" data-testid="text-time-split">Just now</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg" data-testid="row-transaction-shopping">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-destructive/20 flex items-center justify-center">
                          <Wallet className="w-4 h-4 text-destructive" />
                        </div>
                        <span className="text-sm font-medium" data-testid="text-transaction-shopping">Shopping</span>
                      </div>
                      <span className="text-sm font-mono text-destructive" data-testid="text-amount-shopping">-$112.00</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg" data-testid="row-transaction-savings">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center">
                          <Target className="w-4 h-4 text-primary" />
                        </div>
                        <span className="text-sm font-medium" data-testid="text-transaction-savings">Savings Goal</span>
                      </div>
                      <span className="text-sm font-mono text-primary" data-testid="text-amount-savings">+$1,500.00</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Features Section */}
        <section id="features" className="py-20 md:py-28 bg-muted/30 border-y border-border/40">
          <div className="container mx-auto px-4 md:px-6">
        ...
        <section id="design" className="py-20 md:py-28">
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              {/* Chart preview */}
              <div className="bg-card rounded-2xl border border-border/50 p-6 shadow-sm" data-testid="card-chart-preview">
                <div className="flex items-center justify-between mb-6">
                  <h4 className="font-semibold" data-testid="text-chart-title">Monthly Spending</h4>
                  <span className="text-xs text-muted-foreground" data-testid="text-chart-period">Last 6 months</span>
                </div>
                <div className="h-48 flex items-end justify-around gap-2">
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-8 md:w-12 bg-primary/20 rounded-t-sm" style={{height: '60px'}}></div>
                    <span className="text-[10px] text-muted-foreground">Jan</span>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-8 md:w-12 bg-primary/30 rounded-t-sm" style={{height: '90px'}}></div>
                    <span className="text-[10px] text-muted-foreground">Feb</span>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-8 md:w-12 bg-primary/40 rounded-t-sm" style={{height: '75px'}}></div>
                    <span className="text-[10px] text-muted-foreground">Mar</span>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-8 md:w-12 bg-primary/60 rounded-t-sm" style={{height: '120px'}}></div>
                    <span className="text-[10px] text-muted-foreground">Apr</span>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-8 md:w-12 bg-primary/80 rounded-t-sm" style={{height: '100px'}}></div>
                    <span className="text-[10px] text-muted-foreground">May</span>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-8 md:w-12 bg-primary rounded-t-sm" style={{height: '140px'}}></div>
              ...
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-display font-bold leading-tight" data-testid="text-design-title">
                  Design that speaks the language of{" "}
                  <span className="text-primary">clarity.</span>
                </h2>
                <p className="text-muted-foreground leading-relaxed" data-testid="text-design-desc">
        ...
        <section id="pricing" className="py-20 md:py-28 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <p className="text-primary-foreground/80 max-w-xl mx-auto mb-8" data-testid="text-cta-desc">
              Join thousands of users who have simplified their financial lives with FinTrack. Start your journey today.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button size="lg" variant="secondary" className="rounded-full" asChild data-testid="button-cta-start">
                <a href="/api/login">
                  Get Started for Free
                </a>
              </Button>
              <Button size="lg" variant="outline" className="rounded-full" data-testid="button-cta-pricing">
                View Pricing
              </Button>
            </div>
          </div>
        ...
        <section className="py-12 border-y border-border/40 bg-muted/30">
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                <p className="text-3xl md:text-4xl font-bold font-display" data-testid="text-stat-users">12K+</p>
                <p className="text-sm text-muted-foreground mt-1" data-testid="text-stat-users-label">Active Users</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-bold font-display" data-testid="text-stat-transactions">$2M+</p>
                <p className="text-sm text-muted-foreground mt-1" data-testid="text-stat-transactions-label">Tracked</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-bold font-display" data-testid="text-stat-savings">98%</p>
                <p className="text-sm text-muted-foreground mt-1" data-testid="text-stat-savings-label">Satisfaction</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-bold font-display" data-testid="text-stat-countries">50+</p>
                <p className="text-sm text-muted-foreground mt-1" data-testid="text-stat-countries-label">Countries</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="py-12 md:py-16 border-t border-border/40">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            {/* Newsletter */}
            <div>
              <h4 className="font-semibold mb-4" data-testid="text-footer-newsletter-heading">Newsletter</h4>
              <p className="text-sm text-muted-foreground mb-4" data-testid="text-footer-newsletter-desc">
